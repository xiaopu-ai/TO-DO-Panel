...
export const MARQUEE_ITEMS: MediaItem[] = [
  { id: "todo", src: "/product-captures/todo.png", fallbackSrc: "", kind: "image", alt: "TO-DO Panel 待办完整面板" },
  { id: "clipboard", src: "/product-captures/clipboard.png", fallbackSrc: "", kind: "image", alt: "TO-DO Panel 剪贴完整面板" },
  { id: "notes", src: "/product-captures/notes.png", fallbackSrc: "", kind: "image", alt: "TO-DO Panel 笔记完整面板" },
  { id: "links", src: "/product-captures/links.png", fallbackSrc: "", kind: "image", alt: "TO-DO Panel 链接完整面板" },
  { id: "recordings", src: "/product-captures/recordings.png", fallbackSrc: "", kind: "image", alt: "TO-DO Panel 录制完整面板" },
  { id: "credentials", src: "/product-captures/credentials.png", fallbackSrc: "", kind: "image", alt: "TO-DO Panel 密钥完整面板" },
];
