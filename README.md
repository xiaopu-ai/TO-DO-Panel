...
| 页面 | 解决什么问题 |
| --- | --- |
| **首页** | 当前窗口、镜子、文件中转、快速录音、随笔记、常用指令、汽水音乐和番茄钟集中在一个 Bento 工作台 |
...
> 当前稳定版本：**1.0.6** · 支持 **macOS 13.0+ 的 Apple Silicon Mac**
...
当前稳定版本为 **v1.0.6**。正在开发但尚未发布的改动会先记录在 `[未发布]`，正式发版时再归档到对应版本，避免 README 随版本增加而持续膨胀。
